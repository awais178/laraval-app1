                ...
                <div class="header-items header__center">
                    @if (is_plugin_active('ecommerce'))
                        <form class="form--quick-search" action="{{ route('public.products') }}"
                            ...
                            <button class="btn btn-warning" type="submit" style="background-color: #FED819;padding-left: 23px;padding-right: 23px; color:black!important; border-color:#FED819; font-weight:bold;
                            border-radius:0px 8px 8px 0px">

                            <span class="svg-icon">
                                            <svg style="font-weight: 800;">
                    ...
                    @if (is_plugin_active('ecommerce'))
                        ...
                        <div class="m-2 d-flex">
                            ...
                            @else
                                ...
                                <li style="list-style: none"><a class="btn btn-warning text-white m-2" href="{{ route('customer.login') }}">Sign In/ Up</a></li>
                            @endif
                            ...
                            @if (is_plugin_active('ecommerce'))
                                <div class="menu--product-categories">
                                    <div class="menu__toggle">
                                                                            <span class="svg-icon">
                                                                                <svg>
                                                                                    <use href="#svg-icon-list"
                                                                                         xlink:href="#svg-icon-list"></use>
                                                                                </svg>
                                                                            </span>
                    ...
                    <div class="navigation__right">
                        @if (is_plugin_active('ecommerce') && EcommerceHelper::isEnabledCustomerRecentlyViewedProducts())
                            <div class="header-recently-viewed"
                                ...
                                <h3 class="recently-title" style="display: none">
