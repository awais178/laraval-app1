<footer id="footer">
            ...
            <div class="yellow-background">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <h1 class="text-dark">Join our newsletter now!</h1>
                            <p>Join now and get our latest updates and promos</p>
                        </div>
                        <div class="col-md-6">
                            <form class="d-flex">
                                <input type="email" name="email" class="form-control w-60" placeholder="Enter your email" id="">
                                <button class="btn btn-dark infoemailbtn-2">Join</button>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-xxxl-wrapper">
        ...
        <div class="container-xxxl">
            <div class="row border-top py-4">
                ...
                <div class="col-lg-6 col-md-4 py-3 text-center">
