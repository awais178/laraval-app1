        ...
        <div class="d-flex justify-content-center align-items-center featured-product-first">
            <div class="text-center">
                {{--        <h1>Featured product 22</h1>--}}
                <h1 class="product__title">
                    <a href="{{ $product->url }}" tabindex="0"><h6>{!! BaseHelper::clean($product->name) !!}</h6></a>
                </h1>
                <h2>
