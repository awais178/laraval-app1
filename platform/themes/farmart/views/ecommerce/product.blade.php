...
<div class="product-detail-container">
    <div class="bg-light py-md-5 px-lg-3 px-2">
        <div class="container-xxxl rounded-7 bg-white py-lg-5 py-md-4 py-3 px-3 px-md-4 px-lg-5">
            <div class="row">
                <div class="col-lg-6 col-md-6 mb-md-5 pb-md-5 mb-3">
                    {!! Theme::partial('ecommerce.product-gallery', compact('product', 'productImages')) !!}
                </div>
                <div class="col-md-6 ps-4 product-details-content">
...
{{--                        <h1>In Stock</h1> <h1>out Of stock</h1>--}}
...
{{--                </div>--}}
    ...
    <div class="container-xxxl">
        <div class="row product-detail-tabs mt-3 mb-4">
            ...
            <div class="col-md-7">
                <div class="col-md-12">
                    <div class="nav nav-pills" id="product-detail-tabs" role="tablist" aria-orientation="horizontal">
...
{{--                        </div>--}}
{{--                    </div>--}}
                    <div class="col-md-12 col-sm-12 col-xs-12 col-review-form">
            ...
            <div class="container">
                <article class="ps-product--header-sticky">
                    ...
                    <div class="ps-product__wrapper">
                        <div class="ps-product__content"><a class="ps-product__title" href="{{ $product->url }}">{!! BaseHelper::clean($product->name) !!}</a>
                            <ul>
