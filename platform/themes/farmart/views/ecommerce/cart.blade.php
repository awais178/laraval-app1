<div class="d-flex text-center justify-content-center align-items-center">
    ...
    <h1 class="text-muted" style="margin-left: 2vw;">Checkout</h1>
</div>
        ...
        <form class="form--shopping-cart cart-form" method="post" action="{{ route('public.cart.update') }}">
            ...
            @if (count($products) > 0)
                <div class="row">
                                ...
                                @foreach (Cart::instance('cart')->content() as $key => $cartItem)
                                    ...
                                    @if (!empty($product))
                                        <tr class="cart-form__cart-item cart_item">
                                            ...
                                            <td class="product-name d-md-table-cell d-block" style="width: 80%"
                    ...
                    <div class="col-md-4">
                        <div class="">
                            <div class="col-12 col-coupon form-coupon-wrapper">
                                <div class="coupon">
                                    <label for="coupon_code">
                                        <h4>{{ __('Have a Coupon Code?') }}</h4>
                                    </label>
...
{{--                                        @endif--}}
                                        ...
                                        @if ($promotionDiscountAmount)
                                            <div class="ps-block__header">
                                                <p>{{ __('Discount promotion') }}
                                                    <span> {{ format_price($promotionDiscountAmount) }}</span></p>
                                            </div>
                                        @endif
...
{{--                                </a>--}}
        ...
        {{--                        @if ($promotionDiscountAmount)--}}
        {{--                            <div class="ps-block__header">--}}
        {{--                                <p>{{ __('Discount promotion') }} <span> {{ format_price($promotionDiscountAmount) }}</span></p>--}}{{--                            </div>--}}
        {{--                        @endif--}}
        {{--                        <div class="order-total d-flex justify-content-between pb-3 mb-3">--}}
        {{--                                    <span class="title">--}}
        {{--                                        <h6 class="mb-0">{{ __('Total') }}</h6>--}}
...
{{--                    <div class="col">--}}
{{--                        <div class="product-inner demo-class">--}}
